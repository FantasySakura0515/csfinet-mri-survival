...
| Table 7 | `survival.csv`, `survival-paired-tests.csv` |
...
The study uses patient-disjoint internal held-out evaluation: 188 training and 47 test patients, with development training/validation of 150/38 within the training group. Model and method choices were fixed before test evaluation, with no test-score-driven selection. This is not external validation.
...
Individual illustrative-case clinical values and image arrays are not supplied in these aggregate files.
