...
def main():
    ...
    split.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    smoke.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    smoke_surv.add_argument("--config", default="configs/survival-v2.json")
    ...
    train.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    infer_seg.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    cache_mri = commands.add_parser("cache-survival-mri", help="Create v2 WT-mask plus masked-MRI 5x155x128x128 survival inputs")
    ...
    train_surv.add_argument("--config", default="configs/survival-v2.json")
    ...
    infer_surv.add_argument("--config", default="configs/survival-v2.json")
    ...
    explain.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    randomize.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    delivery = commands.add_parser("audit-delivery", help="Verify every formal artifact and build manuscript replacements")
    delivery.add_argument("--project-root", default=".")
    delivery.add_argument("--tag", default="v2")
    ...
    schematics.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    release.add_argument("--tag", default="v2")
    ...
    validate_release_parser.add_argument("--tag", default="v2")
    ...
    variants_validate.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    variants_validate.add_argument("--tag", default="v2")
    ...
    variants_test.add_argument("--config", default="configs/reconstruction-v21.json")
    ...
    variants_test.add_argument("--tag", default="v2")
